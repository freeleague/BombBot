...
YOURTOKEN = input('Токен вашего бота: ')
...
def authoring(message):
	bot.send_message(message.chat.id, "Автор бота: @CyberLand_X. По поводу сотрудничества и рекламы писать менеджеру.")
